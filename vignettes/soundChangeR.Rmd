...
knitr::include_graphics("./img/prod.png")
```
...
knitr::include_graphics("./img/perc.png")
```
...
knitr::include_graphics("./img/sub-phon.png")
```
...
Gubian, M., Cronenberg, J., and Harrington, J. (in prep.): Simulating the merger of /I@/ and /e@/ in New Zealand English using an agent-based model.

Cronenberg, J. (in prep.): New Approaches to the Study of Sound Change: The Case of Aspiration in Andalusian Spanish. Dissertation, LMU Munich.
